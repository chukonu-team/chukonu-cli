...
def build_patent_advanced_body(
    *,
    ...
    # 主体：旧字段为规范化完整名称过滤，*_query 为模糊召回
    ap: str | None = None,
    ap_query: str | None = None,
    first_ap: str | None = None,
    first_ap_query: str | None = None,
    inventor: str | None = None,
    inventor_query: str | None = None,
    first_in: str | None = None,
    first_in_query: str | None = None,
    ...
    explicit: dict[str, Any] = {
        ...
        "ap_query": ap_query,
        "first_ap": first_ap,
        "first_ap_query": first_ap_query,
        "inventor": inventor,
        "inventor_query": inventor_query,
        "first_in": first_in,
        "first_in_query": first_in_query,
        "no_ap": no_ap,
        "no_in": no_in,
